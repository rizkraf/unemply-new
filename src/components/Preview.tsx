        ...
        >
          ...
          <div className="h-14 border-b border-border flex items-center px-6 gap-4 bg-background/50">
            ...
            <div className="flex-1 flex justify-center">
              <div className="w-64 h-8 rounded-md bg-foreground/5 border border-foreground/5 flex items-center justify-center text-xs text-foreground/40 font-mono">
          ...
          <div className="flex h-[600px]">
            ...
            <div className="w-64 border-r border-border p-4 hidden md:flex flex-col gap-2 bg-background/30">
              <div className="px-3 py-2 text-sm font-medium text-foreground/40 uppercase tracking-wider mb-2">Menu</div>
              <div className="px-3 py-2 rounded-lg bg-foreground/10 text-foreground text-sm font-medium flex items-center gap-3">
                <div className="w-4 h-4 rounded-sm bg-indigo-500" /> Board
              </div>
              <div className="px-3 py-2 rounded-lg hover:bg-foreground/5 text-foreground/60 text-sm font-medium flex items-center gap-3 transition-colors">
            ...
            <div className="flex-1 p-8 bg-background/10">
              <div className="flex justify-between items-center mb-8">
                <div>
                  <h3 className="text-2xl font-bold text-foreground mb-1">Overview</h3>
                  <p className="text-foreground/50 text-sm">Update terakhir: Hari ini, 09:41 WIB</p>
                </div>
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                <div className="p-6 rounded-2xl border border-border bg-surface/50">
                  <p className="text-foreground/50 text-sm mb-2">Total Lamaran</p>
                  <p className="text-3xl font-bold text-foreground">24</p>
                </div>
                <div className="p-6 rounded-2xl border border-border bg-surface/50">
                  <p className="text-foreground/50 text-sm mb-2">Interview Rate</p>
                  <p className="text-3xl font-bold text-accent">12.5%</p>
                </div>
                <div className="p-6 rounded-2xl border border-border bg-surface/50">
                  <p className="text-foreground/50 text-sm mb-2">Active Follow-ups</p>
              ...
              <div className="p-6 rounded-2xl border border-border bg-surface/50 h-64">
                ...
                <div className="space-y-4">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="flex items-center gap-4 py-2 border-b border-foreground/5 last:border-0">
                      <div className="w-10 h-10 rounded-full bg-foreground/5 flex items-center justify-center">
                        <div className="w-2 h-2 rounded-full bg-accent" />
                      </div>
                      <div>
                        <p className="text-sm text-foreground/90">Status berubah ke <span className="text-accent">Interview</span></p>
                        <p className="text-xs text-foreground/40">Product Designer di Gojek • 2 jam lalu</p>
                      </div>
                    </div>
                  ))}
                </div>
